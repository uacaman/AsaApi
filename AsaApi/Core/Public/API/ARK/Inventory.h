...
struct UPrimalInventoryComponent : UActorComponent
{
    ...
    UPrimalItem* AddItem(const FItemNetInfo* theItemInfo, bool bEquipItem, bool bAddToSlot, bool bDontStack, FItemNetID* InventoryInsertAfterItemID, bool bShowHUDNotification, bool bDontRecalcSpoilingTime, bool bForceIncompleteStacking, AShooterCharacter* OwnerPlayer, bool bIgnoreAbsoluteMaxInventory, bool bInsertAtItemIDIndexInstead, bool doVersionCheck, bool DontHaveClientRefreshAttachmentsAfterUpdatingItem) { return NativeCall<UPrimalItem*, const FItemNetInfo*, bool,bool,bool,FItemNetID*, bool,bool,bool,AShooterCharacter*, bool,bool,bool,bool>(this, "UPrimalInventoryComponent.AddItem(FItemNetInfo&,bool,bool,bool,FItemNetID*,bool,bool,bool,AShooterCharacter*,bool,bool,bool,bool)", theItemInfo, bEquipItem, bAddToSlot, bDontStack, InventoryInsertAfterItemID, bShowHUDNotification, bDontRecalcSpoilingTime, bForceIncompleteStacking, OwnerPlayer, bIgnoreAbsoluteMaxInventory, bInsertAtItemIDIndexInstead, doVersionCheck, DontHaveClientRefreshAttachmentsAfterUpdatingItem); }
